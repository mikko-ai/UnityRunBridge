    ...
    public sealed class ComponentReflectionTests
    {
        ...
        public void TryGetMemberValue_ReadsInheritedProperty()
        {
            ...
            try
            {
                ...
                bool ok = ComponentReflection.TryGetMemberValue(go, typeof(Camera), "orthographic", out object value, out string error);
        ...
        public void TryGetMemberValue_ComponentNotPresent_ReturnsFalse()
        {
            ...
            try
            {
                bool ok = ComponentReflection.TryGetMemberValue(go, typeof(Camera), "orthographic", out _, out _);
                Assert.IsFalse(ok);
            }
            finally
            {
