...
namespace Mk.UnityAgentBridge.Editor.Profiling
{
    ...
    internal static class ProfilingController
    {
        ...
        {
            CapabilityRegistry.Declare("profiling");
            RouteTable.Register("POST", "profiling/start", Start);
            RouteTable.Register("POST", "profiling/stop", Stop);
            RouteTable.Register("GET", "profiling/status", Status);
        }
